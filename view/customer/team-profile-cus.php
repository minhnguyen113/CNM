...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_profile'])) {
	...
	if ($updateSuccess) {
		...
		header("Location: team-profile-cus.php?id=$userId&status=success");
						...
						<li class="lh-sb-item sb-drop-item">
							...
							<ul class="lh-sb-drop condense">
								<li class="list"><a href="./index.php" class="lh-page-link drop">
										<i class="fa-solid fa-code-commit"></i>Trang chủ</a></li>
							</ul>
							<ul class="lh-sb-drop condense">
								<li class="list"><a href="./history-booking.php" class="lh-page-link drop">
										<i class="fa-solid fa-code-commit"></i>Lịch sử đặt bàn</a></li>
							</ul>
						</li>
