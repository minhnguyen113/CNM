...
<!-- Mirrored from maraviyainfotech.com/projects/luxurious-html-v22/admin/forgot.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jan 2025 15:13:57 GMT -->
<head>
	<meta charset="utf-8">
									...
									<div class="hero-container">
										...
										<form class="forgot-form" method="post">
											<div class="imgcontainer">
												<a href="./index.php"><img src="assets/img/logo/full-logo.png" alt="logo" class="logo"></a>
											</div>
											<div class="input-control">
												...
												<div class="login-with-btns">
													<span class="already-acc">Return to<a href="./signin.php" class="login-btn">Login</a></span>
												</div>
											</div>
										</form>
									</div>
