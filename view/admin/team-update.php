...
<!-- Mirrored from maraviyainfotech.com/projects/luxurious-html-v22/admin/./team-update.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jan 2025 15:13:51 GMT -->
											...
											<div class="lh-team-block-img">
												<div class="lh-team-block-detail">
													<div class="profile-img">
														<div class="avatar-preview">
															<div class="t-img" id="imagePreview"
																style="background-image: url(assets/img/user/11.jpg); background-position: center;">
															</div>
														</div>
													...
													<div class="form-group p-b-15">
														<input type="text" class="form-control" id="name_profile"
															placeholder="Enter name" value="Wiley Waites">
													</div>
													<div class="lh-settings">
														<a href="#" class="lh-btn-primary m-r-10">Update Profile</a>
												...
												<div class="form-group">
													<textarea class="form-control" id="profile_detail" rows="9"
														placeholder="Enter Details">I am a team leader of Luxurious technology. I have a 6+ years of experience. I have experience using PHP, HTML, CSS, JavaScript/jQuery, MySQL and associated frameworks to build specialized webpages. I specialize in WordPress customizations, CSS animation and custom features.
													</textarea>
												</div>
											</div>
										</div>
													...
													<li><strong>Email 1 : </strong>
														<div class="form-group">
															<input type="email" class="form-control"
																placeholder="Enter email" value="support2@exapmle1.com">
														</div>
													</li>
													<li><strong>Email 2 : </strong>
														<div class="form-group">
															<input type="email" class="form-control"
																placeholder="Enter email" value="support2@exapmle2.com">
														</div>
													</li>
												</ul>
											</div>
													...
													<li><strong>Phone Nubmer 1 : </strong>
														<div class="form-group">
															<input type="text" class="form-control"
																placeholder="Enter number" value="(123) 123 456 7890">
														</div>
													</li>
											...
											<div class="lh-team-detail">
												...
												<ul>
													<li><strong>Account Name : </strong>
														<div class="form-group">
															<input type="text" class="form-control"
																placeholder="Enter acc name" value="Wiley Waites">
														</div>
													</li>
