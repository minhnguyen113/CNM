...
<!-- Mirrored from maraviyainfotech.com/projects/luxurious-html-v22/admin/role.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 21 Jan 2025 15:13:59 GMT -->
				...
				<div class="row">
					<div class="col-xxl-4 col-xl-4 col-md-6">
						<div class="role-card">
							<div class="lh-card lh-role">
								<div class="lh-card-header">
									<h4 class="lh-card-title">Branch Head</h4>
								</div>
						...
						<div class="role-card">
							<div class="lh-card lh-role">
								<div class="lh-card-header">
									<h4 class="lh-card-title">Manager</h4>
								</div>
								<div class="lh-card-content label-card">
									<div class="lh-role-item">
										<div class="team-detail">
						...
						<div class="role-card">
							<div class="lh-card lh-role">
								<div class="lh-card-header">
									<h4 class="lh-card-title">Accountant</h4>
								</div>
								<div class="lh-card-content label-card">
									<div class="lh-role-item">
										<div class="team-detail">
					...
					<div class="col-xxl-4 col-xl-4 col-md-6 order-md-3">
						<div class="role-card">
							<div class="lh-card lh-role">
								<div class="lh-card-header">
									<h4 class="lh-card-title">Team Leader</h4>
								</div>
								<div class="lh-card-content label-card">
									<div class="lh-role-item">
										<div class="team-detail">
						...
						<div class="role-card">
							<div class="lh-card lh-role">
								<div class="lh-card-header">
									<h4 class="lh-card-title">Team Spa</h4>
								</div>
								<div class="lh-card-content label-card">
									<div class="lh-role-item">
										<div class="team-detail">
						...
						<div class="role-card">
							<div class="lh-card lh-role">
								<div class="lh-card-header">
									<h4 class="lh-card-title">Team Gym</h4>
								</div>
								<div class="lh-card-content label-card">
									<div class="lh-role-item">
										<div class="team-detail">
					...
					<div class="col-xxl-4 col-xl-4 col-md-6">
						<div class="role-card">
							<div class="lh-card lh-role">
								<div class="lh-card-header">
									<h4 class="lh-card-title">Team Restaurant</h4>
								</div>
								<div class="lh-card-content label-card">
									<div class="lh-role-item">
										<div class="team-detail">
						...
						<div class="role-card">
							<div class="lh-card lh-role">
								<div class="lh-card-header">
									<h4 class="lh-card-title">Team Marketing</h4>
								</div>
								<div class="lh-card-content label-card">
									<div class="lh-role-item">
										<div class="team-detail">
